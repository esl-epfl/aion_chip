...
module sg13g2_dfrbp_1 (
  ...
  buf (xcr_0, 0);
  ihp_dff_r ihp_dff_r_u(
      int_fwire_IQ, notifier, delayed_CLK, delayed_D, int_fwire_r, xcr_0
  );
  buf (Q, int_fwire_IQ);
...
module sg13g2_dlhq_1 (
  ...
  ihp_latch ihp_latch_u(
      int_fwire_IQ, notifier, delayed_GATE, delayed_D
  );
  buf (Q, int_fwire_IQ);
...
module sg13g2_dlhr_1 (
  ...
  not (int_fwire_r, delayed_RESET_B);
  ihp_latch ihp_latch_u_r(
      int_fwire_IQ, notifier, delayed_GATE, delayed_D, int_fwire_r
  );
  buf (Q, int_fwire_IQ);
  not (int_fwire_IQN, int_fwire_IQ);
  buf (Q_N, int_fwire_IQN);
...
module sg13g2_dllr_1 (
  ...
  not (int_fwire_r, delayed_RESET_B);
  ihp_latch ihp_latch_u_r(
      int_fwire_IQ, notifier, int_fwire_clk, delayed_D, int_fwire_r
  );
  buf (Q, int_fwire_IQ);
  not (int_fwire_IQN, int_fwire_IQ);
  buf (Q_N, int_fwire_IQN);
...
module sg13g2_lgcp_1 (
  ...
  ihp_latch ihp_latch_u(
      int_fwire_int_GATE, notifier, int_fwire_clk, delayed_GATE
  );
...
module sg13g2_sdfbbp_1 (
  ...
  ihp_mux2 ihp_mux2_u(
      int_fwire_d, delayed_D, delayed_SCD, delayed_SCE
  );
  not (int_fwire_s, delayed_SET_B);
  not (int_fwire_r, delayed_RESET_B);
  buf (xcr_0, 0);
  ihp_dff_sr_1 ihp_dff_sr_1_u (
      int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_s, int_fwire_r, xcr_0
  );
  buf (Q, int_fwire_IQ);
  not (int_fwire_IQN, int_fwire_IQ);
  buf (Q_N, int_fwire_IQN);
...
module sg13g2_sdfrbp_1 (
  ...
  buf (xcr_0, 0);
  ihp_dff_r ihp_dff_r_u(
      int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_r, xcr_0
  );
  buf (Q, int_fwire_IQ);
  not (int_fwire_IQN, int_fwire_IQ);
  buf (Q_N, int_fwire_IQN);
...
module sg13g2_slgcp_1 (
  ...
  ihp_latch ihp_latch_u(
      int_fwire_int_GATE, notifier, int_fwire_clk, int_fwire_test
  );
  and (GCLK, delayed_CLK, int_fwire_int_GATE);
