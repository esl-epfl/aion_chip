...
if {[lsearch [cellname list topcells] {AION_nand2_o21ai_0}] < 0} {
    set _fp [open {/foss/designs/aion_chip/flow/regress/AION_nand2_o21ai_0/drc/AION_nand2_o21ai_0.magic.drc/drc_AION_nand2_o21ai_0.cellmismatch} w]
    puts $_fp [cellname list topcells]
    close $_fp
    quit -noprompt
}
load AION_nand2_o21ai_0
set drc_rpt_path /foss/designs/aion_chip/flow/regress/AION_nand2_o21ai_0/drc/AION_nand2_o21ai_0.magic.drc/AION_nand2_o21ai_0.magic.drc.rpt
set fout [open $drc_rpt_path w]
set oscale [cif scale out]
set cell_name AION_nand2_o21ai_0
select top cell
drc euclidean on
drc style drc(full)
drc check
