...
if {[lsearch [cellname list topcells] {AION_a21oi_nor2_1}] < 0} {
    set _fp [open {/foss/designs/aion_chip/flow/regress/AION_a21oi_nor2_1/drc/AION_a21oi_nor2_1.magic.drc/drc_AION_a21oi_nor2_1.cellmismatch} w]
    puts $_fp [cellname list topcells]
    close $_fp
    quit -noprompt
}
load AION_a21oi_nor2_1
set drc_rpt_path /foss/designs/aion_chip/flow/regress/AION_a21oi_nor2_1/drc/AION_a21oi_nor2_1.magic.drc/AION_a21oi_nor2_1.magic.drc.rpt
set fout [open $drc_rpt_path w]
set oscale [cif scale out]
set cell_name AION_a21oi_nor2_1
select top cell
drc euclidean on
drc style drc(full)
drc check
