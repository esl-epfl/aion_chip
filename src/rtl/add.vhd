--------------------------------------------------------------------------------
--                      Normalizer_ZO_30_30_30_F50_uid6_add
...
entity Normalizer_ZO_30_30_30_F50_uid6_add is
...
architecture arch of Normalizer_ZO_30_30_30_F50_uid6_add is
...
--------------------------------------------------------------------------------
--                       PositFastDecoder_32_2_F50_uid4_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity PositFastDecoder_32_2_F50_uid4_add is
    port (clk : in std_logic;
...
architecture arch of PositFastDecoder_32_2_F50_uid4_add is
   component Normalizer_ZO_30_30_30_F50_uid6_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(29 downto 0);
             OZb : in  std_logic;
             Count : out  std_logic_vector(4 downto 0);
...
-------------- Count leading zeros/ones of regime & shift it out --------------
   ...
   RegimeCounter: Normalizer_ZO_30_30_30_F50_uid6_add
      port map ( clk  => clk,
                 OZb => rc,
                 X => regPosit,
                 Count => regLength,
...
--------------------------------------------------------------------------------
--                      Normalizer_ZO_30_30_30_F50_uid10_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, (2007-2020)
...
entity Normalizer_ZO_30_30_30_F50_uid10_add is
    port (clk : in std_logic;
          X : in  std_logic_vector(29 downto 0);
          OZb : in  std_logic;
          Count : out  std_logic_vector(4 downto 0);
...
architecture arch of Normalizer_ZO_30_30_30_F50_uid10_add is
signal level5 :  std_logic_vector(29 downto 0);
signal sozb :  std_logic;
signal count4 :  std_logic;
signal level4 :  std_logic_vector(29 downto 0);
...
--------------------------------------------------------------------------------
--                       PositFastDecoder_32_2_F50_uid8_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Raul Murillo (2021)
...
entity PositFastDecoder_32_2_F50_uid8_add is
    port (clk : in std_logic;
          X : in  std_logic_vector(31 downto 0);
          Sign : out  std_logic;
          SF : out  std_logic_vector(7 downto 0);
...
architecture arch of PositFastDecoder_32_2_F50_uid8_add is
   component Normalizer_ZO_30_30_30_F50_uid10_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(29 downto 0);
             OZb : in  std_logic;
             Count : out  std_logic_vector(4 downto 0);
...
-------------- Count leading zeros/ones of regime & shift it out --------------
   rc <= X(30);
   regPosit <= X(29 downto 0);
   RegimeCounter: Normalizer_ZO_30_30_30_F50_uid10_add
      port map ( clk  => clk,
                 OZb => rc,
                 X => regPosit,
                 Count => regLength,
...
--------------------------------------------------------------------------------
--                  RightShifterSticky31_by_max_31_F50_uid12_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky31_by_max_31_F50_uid12_add is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky31_by_max_31_F50_uid12_add is
...
--------------------------------------------------------------------------------
--                      Normalizer_ZO_32_32_31_F50_uid14_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, (2007-2020)
...
entity Normalizer_ZO_32_32_31_F50_uid14_add is
    port (clk : in std_logic;
          X : in  std_logic_vector(31 downto 0);
          OZb : in  std_logic;
          Count : out  std_logic_vector(4 downto 0);
...
architecture arch of Normalizer_ZO_32_32_31_F50_uid14_add is
...
--------------------------------------------------------------------------------
--                  RightShifterSticky31_by_max_31_F50_uid18_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
entity RightShifterSticky31_by_max_31_F50_uid18_add is
    port (clk : in std_logic;
          X : in  std_logic_vector(30 downto 0);
          S : in  std_logic_vector(4 downto 0);
          padBit : in  std_logic;
...
architecture arch of RightShifterSticky31_by_max_31_F50_uid18_add is
signal ps :  std_logic_vector(4 downto 0);
signal Xpadded :  std_logic_vector(30 downto 0);
signal level5 :  std_logic_vector(30 downto 0);
signal stk4 :  std_logic;
...
--------------------------------------------------------------------------------
--                      PositFastEncoder_32_2_F50_uid16_add
-- VHDL generated for Kintex7 @ 50MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Raul Murillo (2021)
...
entity PositFastEncoder_32_2_F50_uid16_add is
    port (clk : in std_logic;
          Sign : in  std_logic;
...
architecture arch of PositFastEncoder_32_2_F50_uid16_add is
   component RightShifterSticky31_by_max_31_F50_uid18_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(30 downto 0);
             S : in  std_logic_vector(4 downto 0);
             padBit : in  std_logic;
...
-------------- Generate regime - shift out exponent and fraction --------------
   ...
   RegimeGenerator: RightShifterSticky31_by_max_31_F50_uid18_add
      port map ( clk  => clk,
                 S => regValue,
                 X => inputShifter,
                 padBit => padBit,
...
architecture arch of PositAdder is
   component PositFastDecoder_32_2_F50_uid4_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             Sign : out  std_logic;
             SF : out  std_logic_vector(7 downto 0);
   ...
   component PositFastDecoder_32_2_F50_uid8_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             Sign : out  std_logic;
             SF : out  std_logic_vector(7 downto 0);
   ...
   component RightShifterSticky31_by_max_31_F50_uid12_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(30 downto 0);
             S : in  std_logic_vector(4 downto 0);
             padBit : in  std_logic;
   ...
   component Normalizer_ZO_32_32_31_F50_uid14_add is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             OZb : in  std_logic;
             Count : out  std_logic_vector(4 downto 0);
   ...
   component PositFastEncoder_32_2_F50_uid16_add is
      port ( clk : in std_logic;
             Sign : in  std_logic;
             SF : in  std_logic_vector(8 downto 0);
             Frac : in  std_logic_vector(26 downto 0);
...
--------------------------- Start of vhdl generation ---------------------------
---------------------------- Decode X & Y operands ----------------------------
   X_decoder: PositFastDecoder_32_2_F50_uid4_add
      port map ( clk  => clk,
                 X => X,
                 Frac => X_f,
                 NZN => X_nzn,
                 SF => X_sf,
                 Sign => X_sgn);
   Y_decoder: PositFastDecoder_32_2_F50_uid8_add
      port map ( clk  => clk,
                 X => Y,
                 Frac => Y_f,
                 NZN => Y_nzn,
...
---------------- Compute exponents difference & align fractions ----------------
   ...
   RightShifterFraction: RightShifterSticky31_by_max_31_F50_uid12_add
      port map ( clk  => clk,
                 S => frac_offset,
                 X => input_shifter,
                 padBit => pad_bit,
...
-------------------------------- Add fractions --------------------------------
   ...
   FractionNormalizer: Normalizer_ZO_32_32_31_F50_uid14_add
      port map ( clk  => clk,
                 OZb => count_type,
                 X => add_frac_shift,
                 Count => count,
...
--------------------------- Data Rounding & Encoding ---------------------------
   ...
   PositEncoder: PositFastEncoder_32_2_F50_uid16_add
      port map ( clk  => clk,
                 Frac => norm_frac,
                 Guard => grd,
                 NZN => XY_nzn,
